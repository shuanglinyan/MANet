...
from model.pytorch_transformers import BertModel, BertConfig, BertTokenizer
...
class Bert(nn.Module):
    ...
    def forward(self, tokens, segments, input_masks):
        ...
        output, _ = self.textExtractor(tokens, token_type_ids=segments,attention_mask=input_masks)
