...
class options():
    def __init__(self):
        ...
        self._par.add_argument('--model_name', type=str, default='MIANet-bert-test', help='experiment name')
        self._par.add_argument('--mode', type=str, default='train', help='choose mode [train or test]')

        self._par.add_argument('--epoch', type=int, default=70, help='train epoch')
        ...
        self._par.add_argument('--lr', type=float, default=0.001, help='initial learning rate for adam')  # default=0.001
        self._par.add_argument('--wd', type=float, default=0.00004)
        self._par.add_argument('--epsilon', type=float, default=1e-8)
        self._par.add_argument('--margin', type=float, default=0.2, help='ranking loss margin')
        self._par.add_argument('--cr_beta', type=float, default=0.1, help='ranking loss margin')  # default=0.1
        ...
        self._par.add_argument('--num_clusters', type=int, default=6, help='the num of image part')  # default=6
        ...
        self._par.add_argument('--seed', type=int, default=0)
        ...
        # self._par.add_argument('--dataset_root', type=str, default='D:/Datasets/CUHK-PEDES', help='data root of the Data')
        self._par.add_argument('--dataset_root', type=str, default='/opt/data/private/Datasets/CUHK-PEDES', help='data root of the Data')
