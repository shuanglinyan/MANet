...
class CUHKPEDEDataset(data.Dataset):
    def __init__(self, opt, tran):
        ...
        self.img_path = [os.path.join(opt.dataset_root, img_path) for img_path in data_save['img_path']]
    ...
    def __getitem__(self, index):
        ...
        return image, label, caption, caption_length, same_id_caption, same_id_caption_length
...
class CUHKPEDE_txt_dateset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        caption_code, caption_length = self.caption_mask(self.caption_code[index])
        caption = self.caption[index]
        return label, caption, caption_length
